...
#        # am I evaluating if the give phrase is a valid phrase here?
#        punc = string.punctuation()
#        if punc in self.phrase.lower():
#            return False
#        elif ' ' in self.phrase.strip(' '):
#            return False
#        else:
#            return True
#        
...
#        punc = string.punctuation()
#        text1 = text.lower()
#        text2 = text1.strip(punc)
#        text_final = text2.strip(' ')
#        if self.phrase.evaluate():
#            if self.phrase.lower() in text_final:
#                return True
#            else:
#                return False
#        else:
...
# this part of code from https://github.com/Per48edjes/MIT-6-0001-PS5/blob/master/ps5.py
